...
public class WhitespaceTokenizerFactory extends TokenizerFactory {
  private  String separators; //separates at any of the string occurences
  /** Creates a new WhitespaceTokenizerFactory */
  public WhitespaceTokenizerFactory(Map<String,String> args) {
    super(args);
    assureMatchVersion();
    this.separators = args.get("separators");
/*    if (!args.isEmpty()) {
  ...
  public WhitespaceTokenizer create(AttributeFactory factory, Reader input) {
    ...
    return new WhitespaceTokenizer(luceneMatchVersion, input,separators);
  }
}
