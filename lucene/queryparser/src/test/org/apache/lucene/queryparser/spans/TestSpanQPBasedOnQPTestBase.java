...
public class TestSpanQPBasedOnQPTestBase extends LuceneTestCase {
  ...
  public static final class QPTestAnalyzer extends Analyzer {
    ...
    public TokenStreamComponents createComponents(String fieldName,Reader input) {
      Tokenizer tokenizer = new MockTokenizer(input,MockTokenizer.SIMPLE, true);
  ...
  protected static class SimpleCJKTokenizer extends Tokenizer {
    protected SimpleCJKTokenizer(Reader input) {
      super(input);
    }
...
//    }
  ...
  private class SimpleCJKAnalyzer extends Analyzer {
    @Override
    public TokenStreamComponents createComponents(String fieldName,Reader input) {
      return new TokenStreamComponents(new SimpleCJKTokenizer(input));
    }
  }
  ...
  public void testOperatorVsWhitespace() throws Exception { //LUCENE-2566
    ...
    Analyzer a = new Analyzer() {
      @Override
      public TokenStreamComponents createComponents(String fieldName,Reader input) {
        return new TokenStreamComponents(new MockTokenizer(input,MockTokenizer.WHITESPACE, false));
      }
    };
