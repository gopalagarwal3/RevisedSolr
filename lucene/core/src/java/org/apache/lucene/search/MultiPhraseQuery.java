...
public class MultiPhraseQuery extends Query {
  ...
  private int nearPre =0;
  private int nearPost =0;
  private int slop =0 ;
  /** Sets the phrase slop for this query.
   * @see PhraseQuery#setNearPre(int)
   */
  public void  setSlop(int s) { slop = s; }
  public void setNearPre(int s) {
    if (s < 0) {
  ...
  /** Sets the phrase slop for this query.
   * @see PhraseQuery#getNearPre()
   */
  public int  getSlop() { return slop; }
  public int getNearPre() { return nearPre; }
  public void setNearPost(int s) {
    if (s < 0) {
      throw new IllegalArgumentException("slop value cannot be negative");
    }
    nearPost = s; 
  ...
  private class MultiPhraseWeight extends Weight {
    ...
    public Scorer scorer(AtomicReaderContext context, boolean scoreDocsInOrder,
      ...
      if (nearPost == 0) {
        ...
        return new SloppyPhraseScorer(this, postingsFreqs, nearPost, similarity.simScorer(stats, context));
      }
    }
    ...
    public Explanation explain(AtomicReaderContext context, int doc) throws IOException {
      ...
      if (scorer != null) {
        ...
        if (newDoc == doc) {
          float freq = nearPost == 0 ? scorer.freq() : ((SloppyPhraseScorer)scorer).sloppyFreq();
  ...
  public boolean equals(Object o) {
    ...
    return this.getBoost() == other.getBoost()
      && this.nearPre == other.nearPre
      && this.nearPost == other.nearPost
