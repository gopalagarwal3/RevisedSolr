          ...
          if (hasMoreTokens) {
            ...
            do {
              ...
              if (position > 0) {
                ...
                /*ADDING THIS COND FOR THE ENTITY 
                 * FIELDS POSITION ERROR
                 */
                if(!(field.name().equalsIgnoreCase("number")||field.name().equalsIgnoreCase("date")||field.name().equalsIgnoreCase("numericEntity")
                    ||field.name().equalsIgnoreCase("money")||field.name().equalsIgnoreCase("percentage")||field.name().equalsIgnoreCase("ratio")))
                position--;
              } else if (position < 0) {
