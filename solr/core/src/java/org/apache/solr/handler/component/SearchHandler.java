...
import org.apache.solr.constants.SolrConstants;
...
public class SearchHandler extends RequestHandlerBase implements SolrCoreAware , PluginInfoInitialized
{
  ...
  public void init(PluginInfo info) {
    ...
    if(defaults.get("constantScoring")!=null)
    SolrConstants.constantScoring=(String) defaults.get("constantScoring");
    if(defaults.get("entityFlag")!=null)
    luceneConstants.entityFlag=(String) defaults.get("entityFlag");
  }
  ...
  public void handleRequestBody(SolrQueryRequest req, SolrQueryResponse rsp) throws Exception
  {
    ...
    // Testing code for switches 
    rsp.add("entityFlag", luceneConstants.entityFlag);
    rsp.add("constantScoring", SolrConstants.constantScoring);
